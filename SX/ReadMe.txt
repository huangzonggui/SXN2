================================================================================
MICROSOFT 基础类库: SX 项目概述
===============================================================================

应用程序向导已为您创建了这个 SX 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 SX 应用程序的每个文件的内容。
...
SX.h
这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CSXApp 应用程序类。

SX.cpp
这是包含应用程序类 CSXApp 的主要应用程序源文件。

SX.rc
这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\SX.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 SX.rc 中。
...
SXDoc.h，SXDoc.cpp - 文档
这些文件包含 CSXDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CSXDoc::Serialize)。

SXView.h，SXView.cpp - 文档的视图
这些文件包含 CSXView 类。
CSXView 对象用于查看 CSXDoc 对象。

res\SXDoc.ico
这是图标文件，它用作 CSXDoc 类的 MDI 子窗口的图标。此图标包括在主要资源文件 SX.rc 中。
...
StdAfx.h，StdAfx.cpp
这些文件用于生成名为 SX.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
